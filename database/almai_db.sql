...
-- Dumping data for table almai_db.tbl_alumni_educations: ~3 rows (approximately)
...
-- Dumping data for table almai_db.tbl_colleges: ~2 rows (approximately)
...
INSERT INTO `tbl_courses` (`course_id`, `college_id`, `course_name`, `course_status`, `created_at`, `updated_at`) VALUES
	(1, 1, 'BSIS', 1, '2023-03-16 23:16:33', '0000-00-00 00:00:00'),
	(2, 3, 'BSIT', 1, '2023-03-16 23:16:33', '0000-00-00 00:00:00');
...
-- Dumping data for table almai_db.tbl_jobs: ~1 rows (approximately)
...
-- Dumping data for table almai_db.tbl_users: ~3 rows (approximately)
INSERT INTO `tbl_users` (`user_id`, `user_fullname`, `user_email`, `user_password`, `user_category`, `user_status`, `created_at`, `update_at`) VALUES
	...
	(3, 'Wilson Dy', 'bflcc@gmail.com', '0cc175b9c0f1b6a831c399e269772661', 'E', 1, '2023-04-11 13:59:24', '0000-00-00 00:00:00');
