<?php
$job_id = $router->route['id'];
$job_data = Jobs::dataOf($job_id);
?>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<form id="frmPostJob" autocomplete="off"
							><input type="hidden" name="job_title" value="<?=$job_data['job_id']?>">
							<?= Components::csrf(); ?>
							<!-- Single Wrap -->
							<div class="_dashboard_content">
								<div class="_dashboard_content_header">
									<div class="_dashboard__header_flex">
										<h4><i class="ti-briefcase mr-1"></i>Edit Job Form</h4>
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="col-xl-6 col-lg-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" placeholder="Who do you need?"
													name="job_title" value="<?=$job_data['job_title']?>" required>
											</div>
										</div>
										...
										<div class="col-xl-6 col-lg-6">
											<div class="form-group">
												...
												<input type="text" class="form-control"
													...
													name="salary_details" value="<?=$job_data['salary_details']?>">
											</div>
										</div>
										...
										<div class="col-xl-4 col-lg-6">
											<div class="form-group">
												...
												<select class="form-control select2" name="job_type_id" required>
													...
													<?= JobTypes::options($job_data['job_type_id']) ?>
												</select>
											</div>
										</div>
										...
										<div class="col-xl-4 col-lg-6">
											<div class="form-group">
												...
												<select class="form-control select2" id="job_sched_id" required>
													...
													<?= JobSchedules::options($row['job_sched_id']) ?>
												</select>
											</div>
										</div>
										...
										<div class="col-xl-4 col-lg-6">
											<div class="form-group">
												...
												<input type="number" class="form-control" name="hire_needed" value="<?=$job_data['hire_needed']?>"
...
<script>
	...
	$("#frmPostJob").submit(function(e) {
		...
		$.post(base_controller + "edit_job", $("#frmPostJob").serialize(), function(response, status) {
			if (response == 1) {
				success_add();
				setTimeout(function() {
