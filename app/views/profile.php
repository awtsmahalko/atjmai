				...
				<div class="dashboard-navbar overlio-top">
					...
					<div class="d-navigation">
						<ul id="metismenu">
							...
							<li><a href="messages.html"><i class="ti-email"></i>Skills</a></li>
										...
										<div class="row">
											<div class="col-xl-4 col-lg-4">
												<div class="form-group">
													...
													<input type="text" class="form-control with-light profile-value" data-column='alumni_fname'>
												</div>
											</div>
											<div class="col-xl-4 col-lg-4">
												<div class="form-group">
													<label>Middle Name</label>
													<input type="text" class="form-control with-light profile-value" data-column='alumni_mname'>
												</div>
											</div>
											<div class="col-xl-4 col-lg-4">
												<div class="form-group">
													<label>Last Name</label>
													<input type="text" class="form-control with-light profile-value" data-column='alumni_lname'>
												</div>
											</div>
											...
											<div class="col-xl-6 col-lg-6">
												<div class="form-group">
													...
													<input type="date" class="form-control with-light">
												</div>
											</div>
										</div>
									</div>
						...
						<div class="_dashboard_content">
							...
							<div class="_dashboard_content_body">
								<div class="row">
									...
									<div class="col-xl-6 col-lg-6">
										<div class="form-group">
											<label>Your Hourly Rate in USD</label>
											<div class="rg-slider">
									...
									<div class="col-xl-6 col-lg-6">
										<div class="form-group">
											<div class="label_flex">
												<label class="fl_01">Attachments</label>
												<div class="custom-file">
													<input type="file" class="custom-file-input" id="yourfile">
													<label class="custom-file-label" for="yourfile"><i class="fa fa-plus"></i></label>
												</div>
											</div>
											<div class="row">
									...
									<div class="col-xl-6 col-lg-6">
										<div class="form-group">
											<label>Tagline</label>
											<input type="text" class="form-control with-light" value="SEO Expert">
										</div>
									</div>
									<div class="col-xl-6 col-lg-6">
										<div class="form-group with-light">
											...
											<select id="country" class="form-control ">
												...
												<option value="5">Pakistaan</option>
											</select>
										</div>
									</div>
									<div class="col-xl-12 col-lg-12">
								...
								<div class="row">
									...
									<div class="col-xl-12 col-lg-12">
										<div class="form-group">
											...
											<label for="sec" class="checkbox-custom-label">Enable Two-Step Verification via Phone</label>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="modal-body">
				...
				<div class="social_logs mb-4">
					<ul class="shares_jobs text-center">
						<li><a href="#" class="share fb">Sign out</a></li>
