          ...
          <div class="row">
            <div class="col-xl-12 col-lg-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control educ-value" data-column="educ_degree" name='educ_degree'
            ...
            <div class="col-xl-12 col-lg-12">
              <div class="form-group">
                ...
                <input type="text" class="form-control educ-value" data-column="educ_school" name='educ_school'
                  placeholder="NONESCOST" required>
              </div>
            </div>
            <div class="col-xl-12 col-lg-12">
              <div class="form-group">
                <label>Honors Received</label>
                <input type="text" class="form-control educ-value" data-column="honor_received" name='honor_received'
                  placeholder="Cumlaude">
              </div>
            </div>
            <div class="col-xl-6 col-lg-6">
              <div class="form-group">
                <label>Year Start</label>
                <input type="number" class="form-control educ-value" data-column="year_enrolled" name='year_enrolled'
                  required>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6">
              <div class="form-group">
                ...
                <input type="number" class="form-control educ-value" data-column="year_graduated" name='year_graduated'
                  required>
              </div>
            </div>
          </div>
